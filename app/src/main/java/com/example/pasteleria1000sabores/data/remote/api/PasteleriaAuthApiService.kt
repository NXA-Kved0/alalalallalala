...
import com.example.pasteleria1000sabores.data.remote.dto.auth.*
import retrofit2.Response
import retrofit2.http.*

/**
 * Servicio API para endpoints de autenticación de pasteleria1000sabores
 */
interface PasteleriaAuthApiService {
    ...
    @POST("auth/login")
    suspend fun login(
        @Body request: LoginPasteleriaRequest
    ): Response<ApiResponse<AuthPasteleriaData>>
    ...
    suspend fun register(
        @Body request: RegisterPasteleriaRequest
    ): Response<ApiResponse<AuthPasteleriaData>>
