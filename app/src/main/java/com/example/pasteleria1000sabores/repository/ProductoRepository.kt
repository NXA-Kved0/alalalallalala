...
import com.example.pasteleria1000sabores.data.mapper.toModel
import com.example.pasteleria1000sabores.data.mapper.toProductoList
import com.example.pasteleria1000sabores.data.remote.RetrofitClient
import com.example.pasteleria1000sabores.data.remote.dto.producto.CreateProductoRequest
import com.example.pasteleria1000sabores.data.remote.dto.producto.UpdateProductoRequest
...
class ProductoRepository {
    ...
    private val apiService = RetrofitClient.pasteleriaProductoApiService
        ...
        try {
            ...
            if (response.isSuccessful) {
                ...
                if (body != null && body.success == true && body.data != null) {
                    val productos = body.data.toProductoList()
    ...
    suspend fun getProducto(id: String): ApiResult<Producto> = withContext(Dispatchers.IO) {
        try {
            ...
            if (response.isSuccessful) {
                val body = response.body()
                if (body != null && body.success == true && body.data != null) {
                    val producto = body.data.toModel()
