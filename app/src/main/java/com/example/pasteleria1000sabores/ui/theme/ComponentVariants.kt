...
sealed class ButtonVariant(
    ...
    object Destructive : ButtonVariant(
        backgroundColor = com.example.pasteleria1000sabores.ui.theme.Destructive,
        contentColor = Color.White,
...
sealed class BadgeVariant(
    ...
    object Success : BadgeVariant(
        ...
        borderColor = com.example.pasteleria1000sabores.ui.theme.Success.copy(alpha = 0.3f),
        textColor = Color(0xFF166534) // green-800
    )

    object Destructive : BadgeVariant(
        backgroundColor = DestructiveLight,
        borderColor = com.example.pasteleria1000sabores.ui.theme.Destructive.copy(alpha = 0.3f),
        textColor = Color(0xFF991B1B) // red-800
    )

    object Warning : BadgeVariant(
        backgroundColor = WarningLight,
        borderColor = com.example.pasteleria1000sabores.ui.theme.Warning.copy(alpha = 0.3f),
